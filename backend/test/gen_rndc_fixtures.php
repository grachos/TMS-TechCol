 ...
 * can be asserted byte-for-byte. Run:  php backend/test/gen_rndc_fixtures.php
 * Writes: backend/test/rndc_fixtures.json
 */

declare(strict_types=1);

require_once __DIR__ . '/../../legacy/src/Rndc/RndcClient.php';
